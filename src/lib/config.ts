...
export const PROJECT = {
  ...
  version: '1.0.0',
  license: 'GPL-3.0',
  url: 'https://e2e-test-game.minidev.app',
  repository: 'https://github.com/MiniDevPlatform/e2e-test-game',
} as const;
...
export const FEATURES = {
  ...
  // Campaign
  campaign: { enabled: false, levels: [], achievements: [], saveProgress: true, saveKey: 'e2e-test-game_progress' },
